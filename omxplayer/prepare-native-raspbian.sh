...
REQUIRED_PKGS="ca-certificates binutils libva1 libpcre3-dev libidn11-dev libboost1.50-dev libfreetype6-dev libusb-1.0-0-dev libdbus-1-dev libssl-dev libssh-dev libsmbclient-dev sed pkg-config"
MISSING_PKGS=""
